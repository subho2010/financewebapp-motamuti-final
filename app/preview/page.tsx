...
export default function ReceiptPreview() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <Card className="p-8 shadow-lg print:shadow-none" id="receipt-content">
        <div className="receipt-header text-center mb-8">
          {receiptData.storeInfo?.name && <h1 className="text-2xl font-bold mb-1">{receiptData.storeInfo.name}</h1>}
          ...
          <h2 className="text-xl font-bold mt-4">RECEIPT</h2>
